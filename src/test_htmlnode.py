...
class TestHTMLNode(unittest.TestCase):
    ...
    def test_to_html_with_props_and_children(self):
        child_node = LeafNode("span", "child")
        parent_node = ParentNode("div", [child_node], {"id": "parent-div-id", "class": "parent-div-class"})
        self.assertEqual(parent_node.to_html(), '<div id="parent-div-id" class="parent-div-class"><span>child</span></div>')
